...
export default function DomeGallery({
  ...
  return (
    <>
      ...
      <div
        ref={rootRef}
        className="sphere-root relative w-screen h-screen overflow-hidden"
        style={{
          ['--segments-x']: segments,
          ['--segments-y']: segments,
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(rgba(248, 242, 234, 0) 65%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`
            }}
          />
          ...
          <div
            className="absolute inset-0 m-auto z-[3] pointer-events-none"
            style={{
              WebkitMaskImage: `radial-gradient(rgba(248, 242, 234, 0) 70%, var(--overlay-blur-color, ${overlayBlurColor}) 90%)`,
              maskImage: `radial-gradient(rgba(248, 242, 234, 0) 70%, var(--overlay-blur-color, ${overlayBlurColor}) 90%)`,
